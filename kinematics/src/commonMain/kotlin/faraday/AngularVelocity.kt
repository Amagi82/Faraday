 ...
 * respect to its center of rotation. Orbital angular velocity refers to how fast a point
 ...
 *
 * [Wiki](https://en.wikipedia.org/wiki/Angular_velocity)
 */
@JvmInline
value class AngularVelocity(val radiansPerSecond: Double) : Units<AngularVelocity> {
    @InternalUnitApi
    override val rawValue: Double get() = radiansPerSecond

    @InternalUnitApi
    override fun create(value: Double) = AngularVelocity(value)
}
