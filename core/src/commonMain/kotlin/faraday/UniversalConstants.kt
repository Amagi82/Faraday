...
object UniversalConstants {
     ...
     * traveled by light in vacuum during a time interval of 1⁄299792458 second. According to special relativity,
    ...
    /**
     * The cesium standard is a primary frequency standard in which the photon absorption by transitions between
     * the two hyperfine ground states of cesium-133 atoms are used to control the output frequency.
     *
     * Cesium atomic clocks are the most accurate time and frequency standards, and serve as the primary standard
     * for the definition of the second in the International System of Units (SI). By definition, radiation
     * produced by the transition between the two hyperfine ground states of cesium (in the absence of external
     * influences such as the Earth's magnetic field) has a frequency, ΔνCs, of exactly 9192631770 Hz. That value
     * was chosen so that the cesium second equaled, to the limit of human measuring ability in 1960 when it was
     ...
     */
    const val CESIUM_STANDARD_FREQUENCY = 9_192_631_770
}
