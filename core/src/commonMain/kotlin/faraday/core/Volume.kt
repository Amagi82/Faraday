...
value class Volume(val cubicMeters: Double) : Units<Volume> {
    ...
    @InternalUnitApi
    override val rawValue: Double get() = cubicMeters

    @InternalUnitApi
    override fun create(value: Double) = Volume(value)
...
val Number.cubicInches get() = Volume(cubicMeters = toDouble() * Volume.CUBIC_INCH)
val Number.cubicFeet get() = Volume(cubicMeters = toDouble() * Volume.CUBIC_FOOT)

val Number.teaspoonsUS get() = Volume(cubicMeters = toDouble() * Volume.TEASPOON_US)
val Number.tablespoonsUS get() = Volume(cubicMeters = toDouble() * Volume.TABLESPOON_US)
val Number.fluidOuncesUS get() = Volume(cubicMeters = toDouble() * Volume.FLUID_OUNCE_US)
val Number.cupsUS get() = Volume(cubicMeters = toDouble() * Volume.CUP_US)
val Number.pintsUS get() = Volume(cubicMeters = toDouble() * Volume.PINT_US)
val Number.quartsUS get() = Volume(cubicMeters = toDouble() * Volume.QUART_US)
val Number.gallonsUS get() = Volume(cubicMeters = toDouble() * Volume.GALLON_US)

val Number.teaspoonsImp get() = Volume(cubicMeters = toDouble() * Volume.TEASPOON_IMP)
val Number.tablespoonsImp get() = Volume(cubicMeters = toDouble() * Volume.TABLESPOON_IMP)
val Number.fluidOuncesImp get() = Volume(cubicMeters = toDouble() * Volume.FLUID_OUNCE_IMP)
val Number.pintsImp get() = Volume(cubicMeters = toDouble() * Volume.PINT_IMP)
val Number.quartsImp get() = Volume(cubicMeters = toDouble() * Volume.QUART_IMP)
val Number.gallonsImp get() = Volume(cubicMeters = toDouble() * Volume.GALLON_IMP)
