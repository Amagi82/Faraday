 ...
 *
 * In SI derived units these are measured in lux (lx), or equivalently in lumens per square metre (lm·m−2). In the CGS system, the unit of illuminance is the phot, which is equal to 10000 lux. The foot-candle is a non-metric unit of illuminance that is used in photography.
 *
...
value class Illuminance(val lux: Double) : Units<Illuminance> {
    @InternalUnitApi
    override val rawValue: Double get() = lux

    @InternalUnitApi
    override fun create(value: Double) = Illuminance(value)
}
