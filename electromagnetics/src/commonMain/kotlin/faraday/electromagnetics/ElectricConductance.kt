 ...
 *
 * The resistance R of an object is defined as the ratio of ElectricConductance V across it to current I through it, while the conductance G is the reciprocal: R=V/I, G=I/V = 1/R
 *
...
value class ElectricConductance(val siemens: Double) : Units<ElectricConductance> {
    @InternalUnitApi
    override val rawValue: Double get() = siemens

    @InternalUnitApi
    override fun create(value: Double) = ElectricConductance(value)
}
