...
/**
 * In electronics and electromagnetism, the electrical resistance of an object is a measure of its opposition to the flow of electric current. The inverse quantity is electrical conductance, and is the ease with which an electric current passes. Electrical resistance shares some conceptual parallels with the notion of faraday.derived.mechanical friction. The SI unit of electrical resistance is the ohm (Ω), while electrical conductance is measured in siemens (S).
 *
 ...
 *
 * The resistance R of an object is defined as the ratio of voltage V across it to current I through it, while the conductance G is the reciprocal: R=V/I, G=I/V = 1/R
 *
 ...
 *
 * In other cases, such as a transformer, diode or battery, V and I are not directly proportional. The ratio V over I is sometimes still useful, and is referred to as a chordal resistance or static resistance, since it corresponds to the inverse slope of a chord between the origin and an I–V curve. In other situations, the derivative dV/dI may be most useful; this is called the differential resistance.
 *
...
value class ElectricResistance(val ohms: Double) : Units<ElectricResistance> {
    @InternalUnitApi
    override val rawValue: Double get() = ohms

    @InternalUnitApi
    override fun create(value: Double) = ElectricResistance(value)
}

val Number.ohms get() = ElectricResistance(toDouble())
