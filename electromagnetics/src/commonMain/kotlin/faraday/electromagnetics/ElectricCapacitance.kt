...
value class ElectricCapacitance(val farads: Double) : Units<ElectricCapacitance> {
    @InternalUnitApi
    override val rawValue: Double get() = farads

    @InternalUnitApi
    override fun create(value: Double) = ElectricCapacitance(value)
}
