...
value class ElectricInductance(val henrys: Double) : Units<ElectricInductance> {
    @InternalUnitApi
    override val rawValue: Double get() = henrys

    @InternalUnitApi
    override fun create(value: Double) = ElectricInductance(value)
}
