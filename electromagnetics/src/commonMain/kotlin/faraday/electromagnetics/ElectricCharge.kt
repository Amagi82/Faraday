...
import faraday.UniversalConstants
...
value class ElectricCharge(val coulombs: Double) : Units<ElectricCharge> {
    @InternalUnitApi
    override val rawValue: Double get() = coulombs

    @InternalUnitApi
    override fun create(value: Double) = ElectricCharge(value)

    companion object {
        @Suppress("SameReturnValue")
        val ELEMENTARY_CHARGE get() = UniversalConstants.ELEMENTARY_CHARGE
    }
}
