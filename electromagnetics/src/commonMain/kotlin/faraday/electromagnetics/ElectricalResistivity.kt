...
value class ElectricalResistivity(val ohmMeters: Double) : Units<ElectricalResistivity> {
    @InternalUnitApi
    override val rawValue: Double get() = ohmMeters

    @InternalUnitApi
    override fun create(value: Double) = ElectricalResistivity(value)
}
