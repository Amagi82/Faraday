...
value class ChemicalAmount(val moles: Double) : Units<ChemicalAmount> {
    @InternalUnitApi
    override val rawValue: Double get() = moles

    @InternalUnitApi
    override fun create(value: Double) = ChemicalAmount(value)

    companion object {
        @Suppress("SameReturnValue")
        val AVOGADRO_CONSTANT get() = UniversalConstants.AVOGADRO_CONSTANT
    }
}
