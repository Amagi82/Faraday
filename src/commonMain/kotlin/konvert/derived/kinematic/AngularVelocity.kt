...
inline class AngularVelocity(val radiansPerSecond: Double) : Units<AngularVelocity> {
    override val value: Double get() = radiansPerSecond
    override fun plus(other: AngularVelocity): AngularVelocity = AngularVelocity(radiansPerSecond + other.radiansPerSecond)
    override fun minus(other: AngularVelocity): AngularVelocity = AngularVelocity(radiansPerSecond - other.radiansPerSecond)
    override fun times(factor: Number): AngularVelocity = AngularVelocity(radiansPerSecond * factor.toDouble())
    override fun div(factor: Number): AngularVelocity = AngularVelocity(radiansPerSecond / factor.toDouble())
}
