...
inline class ElectricalResistivity(val ohmMeters: Double) : Units<ElectricalResistivity> {
    override val value: Double get() = ohmMeters
    override fun plus(other: ElectricalResistivity): ElectricalResistivity = ElectricalResistivity(ohmMeters + other.ohmMeters)
    override fun minus(other: ElectricalResistivity): ElectricalResistivity = ElectricalResistivity(ohmMeters - other.ohmMeters)
    override fun times(factor: Number): ElectricalResistivity = ElectricalResistivity(ohmMeters * factor.toDouble())
    override fun div(factor: Number): ElectricalResistivity = ElectricalResistivity(ohmMeters / factor.toDouble())
}
