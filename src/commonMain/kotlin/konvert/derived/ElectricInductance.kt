...
inline class ElectricInductance(val henrys: Double) : Units<ElectricInductance> {
    override val value: Double get() = henrys
    override fun plus(other: ElectricInductance): ElectricInductance = ElectricInductance(henrys + other.henrys)
    override fun minus(other: ElectricInductance): ElectricInductance = ElectricInductance(henrys - other.henrys)
    override fun times(factor: Number): ElectricInductance = ElectricInductance(henrys * factor.toDouble())
    override fun div(factor: Number): ElectricInductance = ElectricInductance(henrys / factor.toDouble())
}

val Number.henrys: ElectricInductance get() = ElectricInductance(toDouble())
