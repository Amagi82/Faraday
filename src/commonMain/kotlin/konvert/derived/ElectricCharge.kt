...
inline class ElectricCharge(val coulombs: Double) : Units<ElectricCharge> {
    override val value: Double get() = coulombs
    override fun plus(other: ElectricCharge): ElectricCharge = ElectricCharge(coulombs + other.coulombs)
    override fun minus(other: ElectricCharge): ElectricCharge = ElectricCharge(coulombs - other.coulombs)
    override fun times(factor: Number): ElectricCharge = ElectricCharge(coulombs * factor.toDouble())
    override fun div(factor: Number): ElectricCharge = ElectricCharge(coulombs / factor.toDouble())
...
val Number.coulombs: ElectricCharge get() = ElectricCharge(toDouble())
