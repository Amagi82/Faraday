...
inline class ElectricCapacitance(val farads: Double) : Units<ElectricCapacitance> {
    override val value: Double get() = farads
    override fun plus(other: ElectricCapacitance): ElectricCapacitance = ElectricCapacitance(farads + other.farads)
    override fun minus(other: ElectricCapacitance): ElectricCapacitance = ElectricCapacitance(farads - other.farads)
    override fun times(factor: Number): ElectricCapacitance = ElectricCapacitance(farads * factor.toDouble())
    override fun div(factor: Number): ElectricCapacitance = ElectricCapacitance(farads / factor.toDouble())
}

val Number.farads: ElectricCapacitance get() = ElectricCapacitance(toDouble())
