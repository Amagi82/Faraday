...
inline class ElectricResistance(val ohms: Double) : Units<ElectricResistance> {
    override val value: Double get() = ohms
    override fun plus(other: ElectricResistance): ElectricResistance = ElectricResistance(ohms + other.ohms)
    override fun minus(other: ElectricResistance): ElectricResistance = ElectricResistance(ohms - other.ohms)
    override fun times(factor: Number): ElectricResistance = ElectricResistance(ohms * factor.toDouble())
    override fun div(factor: Number): ElectricResistance = ElectricResistance(ohms / factor.toDouble())
}

val Number.ohms: ElectricResistance get() = ElectricResistance(toDouble())
