...
inline class Radioactivity(val becquerels: Double) : Units<Radioactivity> {
    override val value: Double get() = becquerels
    override fun plus(other: Radioactivity): Radioactivity = Radioactivity(becquerels + other.becquerels)
    override fun minus(other: Radioactivity): Radioactivity = Radioactivity(becquerels - other.becquerels)
    override fun times(factor: Number): Radioactivity = Radioactivity(becquerels * factor.toDouble())
    override fun div(factor: Number): Radioactivity = Radioactivity(becquerels / factor.toDouble())
}

val Number.becquerels: Radioactivity get() = Radioactivity(toDouble())
