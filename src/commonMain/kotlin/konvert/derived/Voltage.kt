...
inline class Voltage(val volts: Double) : Units<Voltage> {
    override val value: Double get() = volts
    override fun plus(other: Voltage): Voltage = Voltage(volts + other.volts)
    override fun minus(other: Voltage): Voltage = Voltage(volts - other.volts)
    override fun times(factor: Number): Voltage = Voltage(volts * factor.toDouble())
    override fun div(factor: Number): Voltage = Voltage(volts / factor.toDouble())
}
typealias ElectricPotential = Voltage

val Number.volts: Voltage get() = Voltage(toDouble())
