...
inline class ElectricConductance(val siemens: Double): Units<ElectricConductance> {
    override val value: Double get() = siemens
    override fun plus(other: ElectricConductance): ElectricConductance = ElectricConductance(siemens + other.siemens)
    override fun minus(other: ElectricConductance): ElectricConductance = ElectricConductance(siemens - other.siemens)
    override fun times(factor: Number): ElectricConductance = ElectricConductance(siemens * factor.toDouble())
    override fun div(factor: Number): ElectricConductance = ElectricConductance(siemens / factor.toDouble())
}

val Number.siemens: ElectricConductance get() = ElectricConductance(toDouble())
