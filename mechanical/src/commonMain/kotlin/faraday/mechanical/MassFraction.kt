...
/**
 * In chemistry, the mass fraction of a substance within a mixture is the ratio of the mass of that substance to the total mass of the mixture. Mass fraction can also be expressed, with a denominator of 100, as percentage by mass. It is one way of expressing the composition of a mixture in a dimensionless size; mole fraction (percentage by moles, mol%) and volume fraction (percentage by volume, vol%) are others.
 *
 ...
 */
@JvmInline
value class MassFraction(val ratio: Double) : Units<MassFraction> {
    val ppm get() = ratio * 1e6
    val percent get() = ratio * 100

    @InternalUnitApi
    override val rawValue: Double get() = ratio
